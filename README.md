...
## Overview
This repository contains two data management projects demonstrating practical software engineering skills, including Unix command-line data processing, Git version control, and relational database architecture. 

## Repository Structure

### 1. `/Hurricane-Data-Processing` (Coursework 1)
A command-line toolset designed to parse, clean, and visualize geographical tracking data for 2020 Atlantic hurricanes[cite: 23, 24].
